    ...
    <section className="relative min-h-screen flex items-center pt-20 overflow-hidden bg-black">
      ...
      <div className="relative z-10 px-6 md:px-12 max-w-7xl mx-auto w-full">
        ...
        <div className="flex flex-wrap gap-4">
          <a href="https://w.app/vhqabf" target="_blank" rel="noopener noreferrer" className="px-10 py-5 bg-voltdrive-green text-slate-950 rounded-lg text-[12px] font-black uppercase tracking-[0.2em] hover:bg-white transition-all shadow-2xl hover:scale-105 active:scale-95">
            Conheça a Solução
          </a>
